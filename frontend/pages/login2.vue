  ...
  <div class="flex h-full w-full items-center justify-center">
    <UiTabs class="w-[400px]" default-value="account">
      <UiTabsList :pill="false" class="relative grid w-full grid-cols-2">
        <UiTabsTrigger :pill="false" value="account">登入</UiTabsTrigger>
        <UiTabsTrigger :pill="false" value="password">直接註冊</UiTabsTrigger>
        <UiTabsIndicator />
      </UiTabsList>
          ...
          <template #content>
            <UiCardContent class="flex flex-col gap-4">
              <Form class="" @submit="onSubmit">
                ...
                >
                  <UiFormItem>
                    <UiInput v-bind="componentField" placeholder="名字" />
                  </UiFormItem>
                </Field>
          ...
          <template #content>
            <UiCardContent class="flex flex-col gap-4">
              <Form class="" @submit="onSubmit">
                ...
                <div>
                  <UiButton type="submit">註冊</UiButton>
                </div>
              </Form>
            </UiCardContent>
          </template>
